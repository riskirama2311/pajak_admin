...
// Hitung total klien yang akan konsultasi
$total_clients_query = $conn->query("SELECT COUNT(*) as total FROM client");
        ...
        <div class="container">
            ...
            <div class="row mb-4">
                <div class="col text-center">
                    <h2 class="mb-0">Selamat Datang di Dashboard Konsultan</h2>
                    <p class="text-muted">Kelola data klien dan riwayat konsultasi dengan mudah.</p>
                </div>
            </div>
                ...
                <div class="col-md-4">
                    <div class="card text-white bg-primary card-stat">
                        <div class="card-body text-center">
                            ...
                            <p>Klien yang akan berkonsultasi</p>
                        </div>
                    </div>
                </div>
            </div>
